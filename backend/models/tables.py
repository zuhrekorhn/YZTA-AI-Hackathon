...
class Message(Base):
    ...
    sender_type = Column(String, nullable=False)  # "customer", "manager", "ai"
    message_type = Column(String, nullable=False, default="customer_to_ai")  # "customer_to_ai", "manager_to_customer", "manager_to_ai"
