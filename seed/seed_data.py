...
def seed():
    ...
    try:
        ...
        orders = [
            ...
            Order(business_id=b1.id, product_id=p1.id, customer_name="Zeynep Arslan", customer_phone="05361234567", quantity=4, status="teslim edildi", cargo_tracking_no="YK123456", estimated_delivery=today - timedelta(days=3)),
